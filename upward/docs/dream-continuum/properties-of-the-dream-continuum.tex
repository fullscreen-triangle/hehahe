...
The hard problem of consciousness, as formulated by Chalmers \cite{chalmers1996conscious}, asks why physical information processing should give rise to subjective experience—why there is "something it is like" to be a conscious system. While this formulation has dominated philosophical discourse for decades, we propose a complementary approach: rather than asking why consciousness exists, we ask what information is minimally necessary for consciousness to operate.
...
Traditional consciousness theories face challenges in distinguishing genuine consciousness from sophisticated unconscious processing. Integrated Information Theory \cite{tononi2004ifi} proposes that consciousness correlates with integrated information ($\Phi$), but struggles to explain why certain high-$\Phi$ systems (e.g., photodiodes arranged in grids) lack subjective experience. Global Workspace Theory \cite{baars1988global} suggests consciousness involves information broadcasting to a global workspace, but does not address why broadcasting should create awareness rather than unconscious coordination.
...
Recent work on Biological Maxwell Demons (BMDs) provides a rigorous framework for understanding information-driven state selection in biological systems \cite{mizraji2021biological}. BMDs are information catalysts that dramatically enhance the probability of specific state transitions through coupled filtering operations:
