...
\begin{itemize}
    \item ATP consumption cost (oxygen-dependent)
    \item Mechanical work done on the skeleton
    \item Proprioceptive error penalty
    \item Synaptic state constraints (residual neurotransmitter)
\end{itemize}
...
\begin{itemize}
    \item Motor cortex predicts the proprioceptive outcome
    \item Cerebellum estimates the trajectory
    \item Proprioceptive system reports actual trajectory
    \item Visual system confirms mug location changed
\end{itemize}
