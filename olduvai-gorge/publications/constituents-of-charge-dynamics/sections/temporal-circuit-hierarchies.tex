...
\begin{enumerate}
    \item Suppressing the ongoing fast-loop execution (motor command abort).
    \item Re-entering the deliberative state at the slow closure (variance rises again).
    \item Exploring new bias candidates.
    \item Recommitting to a new $b^{\star\star}$.
\end{enumerate}
