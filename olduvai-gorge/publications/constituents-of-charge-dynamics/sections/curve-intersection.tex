...
Remove perception $\to$ thought unconstrained, oscillates wildly (dreams, delirium).
Remove thought $\to$ perception uninterpreted, reflexive only (coma, deep anesthesia).
Remove memory $\to$ intersections isolated, no coherence (deafferentation, amnesia, severe dissociation).
...
This is why:
\begin{itemize}
\item One cannot have the exact same thought twice.
\item One cannot perceive an object identically twice.
